    ...
    <div className="flex flex-col flex-1 mt-24">
      ...
      <div className="space-y-6 text-md lg:text-lg text-grayish">
        <Text as="p" className="leading-loose">
          ...
          learning python and making very basic tools for myself. The very first
          thing I completed was a python program that would download wallpapers.
          It was very clunky and the code wasn&apos;t that great but it was
          something I made so I was proud of it. From there I ventured out and
          experimented in different areas of tech and web development was the
          thing I stuck with. I had some prior experience messing around with
          phpBB forum themes and I thought what the heck, let&apos;s try this
          out!
        </Text>
        <Text as="p" className="leading-loose">
          ...
          subscribing to premium services like Frontend Masters, and engaging in
          developer communities on twitter and slack. I have experience building
