...
# Creating a RESTful API with Express, Prisma and Postgres
...
export const metadata = {
  ...
  description:
    "A short walk-through on how to create an API and follow some best practices",
  date: "2021-05-03",
  tags: ['RESTful', 'express', 'prisma', 'javascript']
};
