...
# Using the JavaScript debugger to squash bugs faster ⚡️
...
Take advantage of the debugger! It will save you a bunch of time when trying to figure out why something isn't working the way it should be.
...
export const metadata = {
  ...
  description:
    "Throw away your console.logs and debug quicker with the JavaScript debugger",
  date: "2021-10-05",
