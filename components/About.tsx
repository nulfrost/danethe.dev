...
export default function About() {
  ...
  return (
    <Section section="about">
      ...
      >
        <Text as="h2" fontSize="36px" fontWeight="bold" mb={50}>
          About
        </Text>
        <Box w="1240px" fontSize={18} opacity={0.7} lineHeight={2}>
          <Text as="p" mb={3}>
          ...
          <Text as="p" mb={3}>
            ...
            idea of thinking of a cool project in your head and then being able
            to immediately execute on it with just a few keystrokes. Today my
            focus is on web development and I’ve been self-teaching for about 2
            years now and continue to push myself to learn more and grow. With
            that being said I do not know everything and feel I can learn a lot
            by working with people who have been developers for a lot longer and
            look forward to an opportunity to learn from them.
          </Text>
          <Text as="p" mb={3}>
            The tech stack I work with is Next.js, TypeScript, GraphQL and
            Prisma to build my personal projects but I have a growing interest
